...
static const ValidatorTestCase ValidatorTests[] = {
    ...
    {
        .name = "test_set_job_bad_job",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Bfs ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ) ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
    ...
    {
        .name = "test_set_algorithm_bad_algorithm",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2 ),
    ...
    {
        .name = "test_set_job_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ) ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
    ...
    {
        .name = "test_set_algorithm_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2 ),
    ...
    {
        .name = "test_set_input_count_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::AddEdge, 0, 1 ),
    ...
    {
        .name = "test_add_input_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::AddEdge, 0, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
    ...
    {
        .name = "test_set_vertex_count_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::AddEdge, 0, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1 ),
    ...
    {
        .name = "test_set_edge_count_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddInput, 5 ),
            Json::ParserEvent( Json::ParserEventType::SetVertexCount, 2 ),
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddEdge, 0, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1 ),
            Json::ParserEvent( Json::ParserEventType::Finish ),
    ...
    {
        .name = "test_set_label_count_malformed",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            ...
            Json::ParserEvent( Json::ParserEventType::SetEdgeCount, 2, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddEdge, 0, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1 ),
            Json::ParserEvent( Json::ParserEventType::Finish ),
        },
        .expected = false
    },
    {
        ...
        .input = { 1,
            ...
            Json::ParserEvent( Json::ParserEventType::AddEdge, 0, 1 ),
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1, 1 ),
            Json::ParserEvent( Json::ParserEventType::Finish ),
        },
        .expected = false
    },
    {
        .name = "test_finish_malformed_0",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            ...
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1 ),
            Json::ParserEvent( Json::ParserEventType::Finish, 1, 0 ),
        },
        .expected = false
    },
    {
        .name = "test_finish_malformed_1",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            ...
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1 ),
            Json::ParserEvent( Json::ParserEventType::Finish, 0, 1 ),
        },
        .expected = false
    },
    {
        .name = "test_finish_malformed_2",
        .input = { 1,
            Json::ParserEvent( Json::ParserEventType::SetJobType, std::to_underlying( Json::Token::Compute ) ),
            Json::ParserEvent( Json::ParserEventType::SetAlgorithm, std::to_underlying( Json::Token::Bfs ), 1 ),
            Json::ParserEvent( Json::ParserEventType::SetInputCount, 1 ),
            ...
            Json::ParserEvent( Json::ParserEventType::SetLabelCount, 1 ),
            Json::ParserEvent( Json::ParserEventType::AddLabel, 1 ),
            Json::ParserEvent( Json::ParserEventType::Finish, 1, 1 ),
        },
        .expected = false
    },
};
